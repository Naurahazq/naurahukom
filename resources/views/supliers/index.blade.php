...
<div class="d-flex hd-cheatsheet container-fluid bg-body">
    <div class="col-md-2" style="margin-top: -28px;">
        <section id="content">
            <h6 class="sticky-xl-top fw-bold pt-3 pt-xl-5 pb-2 pb-xl-3 text-right">Admin</h6>

            <article>
                <div class="bd-heading sticky-xl-top align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2 text-center">
                    <img src="{{asset('image/op.jpg')}}" class="rounded-circle" width="80px" height="80" alt="">
               ...
               <div class="row">
                  <div class="col-md-4">
                     <div class="form-group">
                        <label for="">Cari Laporan Suplier</label>
                  ...
                  <div class="col-md-6">
                     <button type="submit" class="btn btn-outline-success btn-sm">Cari Laporan</button>
                     <button type="submit" class="btn btn-outline-primary btn-sm">Tambah Stock</button>
                </div>
            </div>
        </div>
    </div>
